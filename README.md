...
|---|---|---|
| `@behavioros/schemas` | Zod v4.4.3 schemas for all types | 1.1.1 |
| `@behavioros/core` | 22 engines + SkillEngine + EcosystemRegistry | 1.1.1 |
| `@behavioros/sdk` | High-level TypeScript SDK | 1.1.1 |
| `@behavioros/cli` | CLI: init, compile, validate, status, ecosystem | 1.1.1 |
| `@behavioros/dnas` | DNA YAML pattern catalog | 1.1.1 |
| `@behavioros/mcp-server` | MCP server with 44 tools + 9 resources | 1.1.1 |
