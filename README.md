...
<p align="center">
  ...
  <a href="#"><img src="https://img.shields.io/badge/version-1.1.5-blue" alt="Version" /></a>
...
|---|---|---|
| `@behavioros/schemas` | Zod v4.4.3 schemas for all types | 1.1.5 |
| `@behavioros/core` | 22 engines + SkillEngine + EcosystemRegistry | 1.1.5 |
| `@behavioros/sdk` | High-level TypeScript SDK | 1.1.5 |
| `@behavioros/cli` | CLI: init, compile, validate, status, ecosystem | 1.1.5 |
| `@behavioros/dnas` | DNA YAML pattern catalog | 1.1.5 |
| `@behavioros/mcp-server` | MCP server with 45 tools + 9 resources | 1.1.5 |
