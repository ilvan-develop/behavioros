...
import { DNAValidator } from '@behavioros/core'
import { loadDNA, loadAllDNAs, getDNAManifest } from '../index'
import type { DNAPackage } from '@behavioros/schemas'

const DNA_IDS = ['enterprise-governance', 'military-operations', 'surgical-team', 'lean-factory'] as const
