import type { DNAPackage, BehaviorPattern, AgentPersona, GovernanceRule, QualityGate, WorkflowStep } from '@behavioros/schemas'
...
export class DNAValidator {
  ...
  static validate(dna: DNAPackage): ValidationResult {
    ...
    // 1. Validate personas
    this.validatePersonas(dna, errors, warnings)

    // 2. Validate governance rules
    this.validateGovernance(dna, errors, warnings)

    // 3. Validate quality gates
    this.validateQuality(dna, errors, warnings)

    // 4. Validate patterns
    this.validatePatterns(dna, errors, warnings)

    // 5. Validate workflows
    this.validateWorkflows(dna, errors, warnings)

    // 6. Validate cross-references
    this.validateCrossReferences(dna, errors, warnings)

    // 7. Validate completeness
    this.validateCompleteness(dna, errors, warnings)
  ...
  private static validatePersonas(dna: DNAPackage, errors: ValidationError[], warnings: ValidationWarning[]): void {
  ...
  private static validateGovernance(dna: DNAPackage, errors: ValidationError[], warnings: ValidationWarning[]): void {
  ...
  private static validateQuality(dna: DNAPackage, errors: ValidationError[], warnings: ValidationWarning[]): void {
  ...
  private static validatePatterns(dna: DNAPackage, errors: ValidationError[], warnings: ValidationWarning[]): void {
  ...
  private static validateWorkflows(dna: DNAPackage, errors: ValidationError[], warnings: ValidationWarning[]): void {
  ...
  private static validateCrossReferences(dna: DNAPackage, errors: ValidationError[], warnings: ValidationWarning[]): void {
  ...
  private static validateCompleteness(dna: DNAPackage, errors: ValidationError[], warnings: ValidationWarning[]): void {
    // Check metadata
    if (!dna.description) {
      warnings.push({
