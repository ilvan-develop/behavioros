...
export const createMissionInput = z.object({
  ...
  type: z.enum(['feature', 'bugfix', 'refactor', 'research', 'incident']).describe('Mission type'),
  priority: z
...
export async function createMission(engine: BehaviorOSEngine, input: CreateMissionInput) {
